...
| **[Episode-01-Hayabusa2-Torifune-SCRIPT.md](episodes/01-hayabusa2-torifune/Episode-01-Hayabusa2-Torifune-SCRIPT.md)** | Episode 01 narration script (v1) with shot-by-shot `[VISUAL]` / `[TEXT]` / `[SFX/MUSIC]` cues — the longer original cut (~1,950 words / ~13–15 min). |
| **[Episode-01-…-SCRIPT-v2-FERN-STYLE.md](episodes/01-hayabusa2-torifune/Episode-01-Hayabusa2-Torifune-SCRIPT-v2-FERN-STYLE.md)** | The v2 Fern/Hoog "armchair documentary" rewrite (~1,500 words / ~10 min) — the current prose direction (see the `script-prose-style` memory). |
